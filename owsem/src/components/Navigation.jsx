...
import { Search, ShoppingCart, User, ScanBarcode, FileText, CheckCircle, PackageSearch, FileSignature, Camera, X, Image } from 'lucide-react';
                        ...
                        <div style={{ background: '#202124', borderRadius: '12px', padding: '48px 32px', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                            <div style={{ position: 'relative', width: '64px', height: '64px', marginBottom: '24px' }}>
                                ...
                                <div style={{ width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                    <Image size={32} color="#8ab4f8" fill="#8ab4f8" strokeWidth={1} style={{ opacity: 0.8 }} />
                                </div>
                            </div>
